...
const translations: Record<Locale, Record<string, string>> = {
  zh: {
    ...
    'pricing.lead': '這裡簡要列出目前可購買的定序延伸、完整重測與邀請解鎖方案，並保留一個不限制金額的請我喝咖啡入口。',
    ...
    'pricing.invite.title': '邀請解鎖',
    'pricing.invite.body': '恢復邀請通道與聯絡權限，讓你可以再次對配對對象發出邀請。',
  ...
  en: {
    ...
    'pricing.lead': 'This page briefly lists the purchasable sequencing extensions, full retests, and invite unlocks, while also keeping a flexible buy-me-a-coffee entry point.',
    ...
    'pricing.invite.title': 'Invite Unlock',
    'pricing.invite.body': 'Restore invite and contact privileges so you can reopen outreach to a match.',
    ...
    'matches.inviteUnlock': 'Invite Unlock',
