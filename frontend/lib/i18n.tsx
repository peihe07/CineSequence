...
const translations: Record<Locale, Record<string, string>> = {
  zh: {
    ...
    // Theaters (Groups)
    'theaters.title': '放映廳',
    'theaters.nextStep': '你的 DNA 已經開啟放映廳層。',
    'theaters.assignmentReady': '接下來的片單、共鳴與策展，都會從這些房間開始。',
    'theaters.autoAssign': '基因配組',
    'theaters.deck': '系統會根據你的電影基因，把你帶進最適合開始共同策展的放映廳。',
    'theaters.empty': '目前尚未分配到放映廳',
    'theaters.emptyHint': '點擊「基因配組」，用你目前的 DNA 檔案重新映射適合的房間。',
    'theaters.join': '加入',
    'theaters.leave': '離開',
    'theaters.hidden': '隱藏',
    'theaters.active': '已啟用',
    ...
    'theaters.featuredHint': '先從這個房間最具代表性的片開始看。',
    'theaters.library': '其他放映廳',
    'theaters.libraryHint': '你目前也能進入這些房間，但閱讀重點先放在主放映廳。',
  ...
  en: {
    ...
    'theaters.assignmentReady': 'This is where shared curation, overlap, and watch intent start.',
    'theaters.autoAssign': 'DNA Assign',
    'theaters.deck': 'Your cinematic DNA now maps you into rooms built for shared curation and overlap.',
    'theaters.empty': 'No theaters assigned yet',
    'theaters.emptyHint': 'Run DNA Assign to remap your current profile into matching rooms.',
    'theaters.join': 'Join',
