...
const translations: Record<Locale, Record<string, string>> = {
  zh: {
    ...
    'pricing.title': 'CineSequence 付費方案',
    'pricing.lead': '這裡公開列出目前可購買的定序延伸、完整重測與邀請解鎖方案，供使用者與金流審核查看。',
    ...
    'pricing.paymentTitle': '付款說明',
    'pricing.paymentBody': '本站提供定序延伸、完整重測與邀請解鎖等數位服務。付款流程由 ECPay 安全處理，成功後即時發放對應權限。',
    'pricing.supportLink': '開啟外部付款支援頁',
    'pricing.back': '返回關於頁',
  ...
  en: {
    ...
    'footer.supportAria': 'Open the support page',
    ...
    'pricing.title': 'CineSequence Paid Access',
    'pricing.lead': 'This page publicly lists the currently purchasable sequencing extensions, full retests, and invite unlocks for users and payment review.',
    ...
    'pricing.paymentTitle': 'Payment Notes',
    'pricing.paymentBody': 'The site currently offers sequencing extensions, full retests, and invite unlocks as digital services. ECPay handles checkout and successful payment grants the corresponding entitlement immediately.',
    'pricing.supportLink': 'Open External Support Checkout',
